...
class Database {
    ...
    DisboardtimerGet(guildid) {
        ...
        if (!data) {
            data = { id: `${guildid}`, guild: guildid, hour: 0, minute: 0, second: 0 }
    ...
    DisboardtimerSet(data) {
        this.sql.prepare('INSERT OR REPLACE INTO disboardtimer (id, guild, hour, minute, second) VALUES (@id, @guild, @hour, @minute, @second);').run(data);
    }
    ...
    DissokutimerSet(data) {
        this.sql.prepare('INSERT OR REPLACE INTO dissokutimer (id, guild, hour, minute, second) VALUES (@id, @guild, @hour, @minute, @second);').run(data);
    }
